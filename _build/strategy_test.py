...
class G2S:
    def __init__(self, parent: typing.Any, debug=False):
        ...
        self.RecalInit = State("RecalInit", on_enter=self.parent.debut_recal)
        self.GoBlue = State("GoBlue", on_enter=self.parent.goblue_enter, on_leave=self.parent.goblue_leave)
        self.PushCake = State("PushCake", on_enter=self.parent.pushcake_enter, on_leave=self.parent.pushcake_leave)
        ...
        self.RecalInit.add_transition(self.RecalInitToDropCerise)
        ...
        self.GoGreenPushCakeToEnd = Transition("GoGreenPushCakeToEnd", self.End, self.parent.match_end_guard)
        self.GoGreen.add_transition(self.GoGreenPushCakeToEnd)
        self.PushCake.add_transition(self.GoGreenPushCakeToEnd)
