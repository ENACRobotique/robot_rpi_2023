...
class G2S:
    def __init__(self, parent: typing.Any, debug=False):
        ...
        self.debug = debug
        self.started = False
        self.RecalMarron = State("RecalMarron", on_enter=self.parent.debut_recal)
        ...
        self.GrabMarronCake = State("GrabMarronCake", on_enter=self.parent.marron_enter, on_loop=self.parent.marron_loop)
        ...
        self.RecalCakeToGrabMarronCake = Transition("RecalCakeToGrabMarronCake", self.GrabMarronCake, self.parent.recal_ok)
        self.RecalCake.add_transition(self.RecalCakeToGrabMarronCake)
        self.GrabMarronCakeToRecalMarron = Transition("GrabMarronCakeToRecalMarron", self.RecalMarron, self.parent.marron_grabbed)
        self.GrabMarronCake.add_transition(self.GrabMarronCakeToRecalMarron)
        self.RecalMarronToGoBlue = Transition("RecalMarronToGoBlue", self.GoBlue, self.parent.recal_ok)
        self.RecalMarron.add_transition(self.RecalMarronToGoBlue)
        ...
        self.tr255767521 = Transition("tr255767521", self.End, self.parent.match_end_guard)
        self.GoGreen.add_transition(self.tr255767521)
        self.PushCake.add_transition(self.tr255767521)
        self.DropCerise.add_transition(self.tr255767521)
        self.RecalGreen.add_transition(self.tr255767521)
        self.GrabMarronCake.add_transition(self.tr255767521)
        self.RecalMarron.add_transition(self.tr255767521)
        self.GoBlue.add_transition(self.tr255767521)
        self.RecalBlue.add_transition(self.tr255767521)
